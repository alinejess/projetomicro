...
/*
#include <Keypad.h>                         // Biblioteca do teclado -> não vai mais precisar
#include <Password.h>                       // Biblioteca utilizada para controle de senha -> não precisa
#include <string.h>                         // Biblioteca para copiar string -> não precisa
*/
    ...
    if (id_encontrado == true) {
      if (c == 'e') {
        ...
        if (senha_aux == usuarios[indice].senha) {  // Verifica se a senha digitada esta correta
          ...
          // acende o led verde caso entrada liberada
          //analogWrite(PINO_LED_VERDE, 170);
          digitalWrite(PINO_LED_VERDE, LOW);
          //delay(2000);
          //digitalWrite(PINO_LED_VERDE, HIGH);
          id_encontrado = false;
          ...
          // acende o led vermelho caso entrada negada
          //analogWrite(PINO_LED_VERMELHO, 80);
          digitalWrite(PINO_LED_VERMELHO, LOW);
          //delay(2000);
          //digitalWrite(PINO_LED_VERMELHO, HIGH);
          id_encontrado = false;
